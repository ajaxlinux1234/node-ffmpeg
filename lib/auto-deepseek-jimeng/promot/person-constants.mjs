...
export const history_deepseek_result_txt_fn = () => {
  ...
  const customShot = [
    "运镜方式：镜头跟随图中婴儿，图中场景缓慢自然变成下一场景伴随着婴儿从当前场景起身缓慢自然走到下一个场景，场景变成下一场景，同时婴儿变换为下一场景的主要人物，动态转换流畅自然",
    "运镜方式：镜头跟随图中主要人物，图中场景缓慢自然变成下一场景伴随着图中人物从当前场景缓慢自然走到下一个场景，场景变成下一场景，同时人物变换为下一场景的主要人物，动态转换流畅自然",
  ];
  return title.map((one, index) => {
    return {
      title: one,
      prompt: `中国人面孔，人物正脸，${originTitle[index]},${prompt[index]}，图片中不要显示任何文字，参考图片跟生成的人物图片, 人物正脸全身照，参考生图的人物比例要协调`,
