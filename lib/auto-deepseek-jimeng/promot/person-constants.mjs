...
export const history_deepseek_result_txt_fn = () => {
  ...
  return title.map((one, index) => {
    return {
      title: one,
      prompt: `日本人人面孔，${originTitle[index]},${prompt[index]},生成的图片内容充满图片，不要有黑边，图片中不要显示任何文字，参考图片跟生成的人物图片, 人物正脸全身照，参考生图的人物比例要协调`,
