...
export const history_deepseek_result_txt_fn = () => {
  ...
  return title.map((one, index) => {
    return {
      title: one,
      prompt: `构图是对称的，人物位于画面的中心, 人物近景特写镜头，镜头距离主要人物1米，比例9:16，${originTitle[index]},${prompt[index]}，图片中不要显示任何文字，参考图片跟生成的人物图片, 人物正脸全身照，参考生图的人物比例要协调`,
      shot: customShot,
      lines‌: lines‌[index],
    };
  });
