...
const FILTER_PRESETS = {
  ...
  'historical-portrait': {
    name: '历史人物肖像',
    description: '温暖复古的历史人物专用滤镜，金棕色调',
    filter: 'colorbalance=rs=0.25:gs=0.15:bs=-0.1:rm=0.1:gm=0.05:bm=-0.05,eq=contrast=1.15:saturation=1.1:brightness=0.08:gamma=1.05,vignette=PI/5'
  },
  'golden-age': {
    name: '黄金时代',
    description: '经典黄金时代电影风格，温暖怀旧',
    filter: 'colorbalance=rs=0.3:gs=0.2:bs=-0.15:rm=0.15:gm=0.1:bm=-0.1,eq=contrast=1.2:saturation=1.05:brightness=0.1,curves=vintage'
  },
  'vintage-documentary': {
    name: '复古纪录片',
    description: '纪录片风格的复古效果，适合历史题材',
    filter: 'colorbalance=rs=0.2:gs=0.1:bs=-0.08,eq=contrast=1.1:saturation=0.95:brightness=0.05:gamma=1.1,vignette=PI/6,noise=alls=5:allf=t'
  },
  'sepia-warm': {
    name: '温暖棕褐',
    description: '温暖版本的棕褐色效果，更有历史感',
    filter: 'colorchannelmixer=.393:.769:.189:0:.349:.686:.168:0:.272:.534:.131,colorbalance=rs=0.1:gs=0.05:bs=-0.05,eq=brightness=0.05'
  },
  'old-film-grain': {
    name: '老胶片颗粒',
    description: '带颗粒感的老胶片效果，历史质感强烈',
    filter: 'colorbalance=rs=0.15:gs=0.1:bs=-0.1,eq=contrast=1.05:saturation=0.9:brightness=0.03,noise=alls=8:allf=t,vignette=PI/4'
  },
  'bronze-tone': {
    name: '青铜色调',
    description: '青铜色调效果，庄重的历史感',
    filter: 'colorbalance=rs=0.2:gs=0.15:bs=-0.05:rm=0.1:gm=0.08:bm=-0.03,eq=contrast=1.12:saturation=1.0:brightness=0.06'
  },
...
function listFilters() {
  ...
  const categories = {
    ...
    '历史人物专用': ['historical-portrait', 'golden-age', 'vintage-documentary', 'sepia-warm', 'old-film-grain', 'bronze-tone'],
