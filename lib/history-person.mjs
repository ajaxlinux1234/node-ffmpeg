...
async function generateThumbnail(videoPath, title, outputDir) {
  ...
  try {
    ...
    ass += `Style: Title, ${platformFont}, ${fontSize}, &H0000A5FF, &H0000A5FF, &H80000000, &H80000000, 0, 0, 0, 0, 100, 100, 0, 0, 1, 4, 6, 8, ${CONFIG_SUBTITLE.LEFT_MARGIN}, ${CONFIG_SUBTITLE.RIGHT_MARGIN}, ${CONFIG_SPACING.COVER_TITLE_MARGIN_TOP}, 0\n\n`;
...
export default async function runHistoryPerson(config) {
  ...
  let { url, title, sectionTitle, "bg-music": bgMusic, watermark, titleAnimation, sectionTitleAnimation, name } = config;
