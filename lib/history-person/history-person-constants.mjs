...
export const CONFIG_SPACING = {
  ...
  GLOBAL_TITLE_POSITION_Y_PERCENT: 0.05, // 全局标题Y位置百分比（从顶部）
...
export const CONFIG_AUDIO_VOLUME = {
  // 背景音乐音量配置
  BACKGROUND_MUSIC_VOLUME: 1.5, // 背景音乐音量（0.0-2.0）- 调整：提高到1.0保持适中音量

  // 配音音量配置
  VOICE_CLIP_VOLUME: 1.2, // 片段配音音量（0.0-2.0）- 修复：从5.0降低到1.2

  // 原视频音频音量配置
  ORIGINAL_AUDIO_VOLUME_WITH_BG: 0.7, // 有背景音乐时原音频音量 - 适度降低为背景音乐让路
