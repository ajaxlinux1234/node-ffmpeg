...
export const CONFIG_SUBTITLE = {
  FONT_SIZE_TITLE: 40, // 主要字幕字体大小
  FONT_SIZE_COVER: 80, // 封面标题字体大小
  FONT_SIZE_WATERMARK: 20, // 水印字体大小
  FONT_SIZE_GLOBAL_TITLE: 35, // 全局标题字体大小
  FONT_SIZE_END_TITLE: 45, // 结尾标题字体大小
...
export const CONFIG_SPACING = {
  ...
  GLOBAL_TITLE_POSITION_Y_PERCENT: 0.1, // 全局标题Y位置百分比（从顶部）
...
export const CONFIG_AUDIO_VOLUME = {
  // 背景音乐音量配置
  BACKGROUND_MUSIC_VOLUME: 10.0, // 背景音乐音量（0.0-2.0）

  // 配音音量配置
  VOICE_CLIP_VOLUME: 5.0, // 片段配音音量（0.0-2.0）

  // 原视频音频音量配置
  ORIGINAL_AUDIO_VOLUME_WITH_BG: 1.0, // 有背景音乐时原音频音量
  ORIGINAL_AUDIO_VOLUME_SOLO: 1.0, // 无背景音乐时原音频音量

  // 特殊音效音量配置
  TYPEWRITER_SOUND_VOLUME: 2.0, // 打字机音效音量
